object err_labor_f: Terr_labor_f
  Left = 0
  Top = 0
  Caption = 'err_labor_f'
  ClientHeight = 552
  ...
  object cxGrid: TcxGrid
    ...
    object cxGridDBTableView: TcxGridDBTableView
      ...
      object cxGridDBTableViewBDATE: TcxGridDBColumn
        DataBinding.FieldName = 'BDATE'
        Width = 54
      end
      object cxGridDBTableViewBRESULT: TcxGridDBColumn
        DataBinding.FieldName = 'BRESULT'
        Width = 61
      end
      object cxGridDBTableViewBPLACE: TcxGridDBColumn
        DataBinding.FieldName = 'BPLACE'
        Width = 43
      end
      object cxGridDBTableViewBTYPE: TcxGridDBColumn
        DataBinding.FieldName = 'BTYPE'
        Width = 39
      end
      object cxGridDBTableViewBDOCTOR: TcxGridDBColumn
        DataBinding.FieldName = 'BDOCTOR'
        Width = 59
      end
      object cxGridDBTableViewLBORN: TcxGridDBColumn
        DataBinding.FieldName = 'LBORN'
        Width = 46
      end
      object cxGridDBTableViewSBORN: TcxGridDBColumn
  ...
  object MyQuery: TMyQuery
    ...
    SQL.Strings = (
      'SELECT e.*,p.`NAME`,p.LNAME,p.TYPEAREA from err_labor e'
