...
uses
  ...
  JvExControls,ShellAPI,cxExport,cxGridExportLink,
  JvNavigationPane;
...
type
  Terr_disability_f = class(TForm)
    ...
    cxGridDBTableViewDISABTYPE: TcxGridDBColumn;
    cxGridDBTableViewDATE_DETECT: TcxGridDBColumn;
    ...
    procedure cxGridDBTableViewDISABTYPECustomDrawCell(
      Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
      AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
    procedure cxGridDBTableViewDATE_DETECTCustomDrawCell(
      Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
      AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
...
procedure Terr_disability_f.cxGridDBTableViewDATE_DETECTCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_disability_f.cxGridDBTableViewDISABTYPECustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_disability_f.cxGridDBTableViewTYPEAREACustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_disability_f.FormShow(Sender: TObject);
begin
...
function Terr_disability_f.GetTempDir: string;
  var
...
procedure Terr_disability_f.RzBitBtn1Click(Sender: TObject);
begin
close;
end;

procedure Terr_disability_f.RzBitBtn2Click(Sender: TObject);
begin
MyQuery.Close;
...
procedure Terr_disability_f.RzBitBtn3Click(Sender: TObject);
begin
...
procedure Terr_disability_f.s_textKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
