...
type
  Terr_fp_f = class(TForm)
    ...
    cxGridDBTableViewFPTYPE: TcxGridDBColumn;
    ...
    procedure cxGridDBTableViewFPTYPECustomDrawCell(
      Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
      AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
...
procedure Terr_fp_f.cxGridDBTableViewDATE_SERVCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_fp_f.cxGridDBTableViewFPTYPECustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_fp_f.cxGridDBTableViewSEXCustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_fp_f.cxGridDBTableViewTYPEAREACustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
begin
...
procedure Terr_fp_f.FormShow(Sender: TObject);
begin
...
function Terr_fp_f.GetTempDir: string;
  var
...
procedure Terr_fp_f.RzBitBtn1Click(Sender: TObject);
begin
close;
end;

procedure Terr_fp_f.RzBitBtn2Click(Sender: TObject);
begin
MyQuery.Close;
...
procedure Terr_fp_f.RzBitBtn3Click(Sender: TObject);
begin
...
procedure Terr_fp_f.s_textKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
